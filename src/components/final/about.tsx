      ...
      <div className="grid h-full grid-cols-1 grid-rows-[100svh_100svh] md:grid-cols-2 md:grid-rows-1">
        <article className="relative min-h-0 overflow-hidden">
          ...
          <div className="absolute inset-x-0 bottom-0 z-10 flex flex-col gap-6 px-4 pb-5 pt-10 sm:px-6 sm:pb-6 md:px-8 md:pb-8">
            <div className="max-w-xl text-white">
              <p className="font-amita text-xl font-medium tracking-[1] text-white/75">
                अपनत्व सिंह रावत
              </p>

              <h2 className="mt-2 text-3xl font-semibold tracking-tight sm:text-3xl md:text-4xl">
                Apnatva Singh Rawat
              </h2>
        ...
        <article className="flex min-h-0 flex-col bg-background px-4 py-5 sm:px-6 sm:py-6 md:px-8 md:py-8">
          <p className="text-sm leading-7 text-muted-foreground sm:text-base">
            ...
            currently working freelance on personal and portfolio websites. When
            I am not working you can find me running, training, reading up on
            psychology, travelling and capturing moments, or sharing my opinions
            with the world. <br />
            <br />
