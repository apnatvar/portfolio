  ...
  return (
    ...
    >
      <div className="relative mx-auto flex h-full w-full max-w-7xl items-center justify-center px-4 py-6 sm:px-6 md:px-8">
        <p
          ref={promptRef}
          className="pointer-events-none absolute inset-x-0 top-1/2 z-20 -translate-y-1/2 text-center text-sm font-medium tracking-[0.24em] text-muted-foreground uppercase sm:text-lg"
        >
          <span className="text-2xl">T</span>ech{" "}
          <span className="text-2xl">S</span>kills <br />
          <span className="text-xs">Scroll to see</span>
        </p>
