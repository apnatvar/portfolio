  ...
  useFrame((state) => {
    ...
    particles.forEach((particle, i) => {
      ...
      if (dist < magnetRadius) {
        ...
        const wave =
          Math.sin(variableT * waveSpeed + angle) * (0.5 * waveAmplitude);
        ...
        targetPos.z =
          mz * depthFactor +
          Math.sin(variableT) * (1 * waveAmplitude * depthFactor);
      }
      ...
      const finalScale =
        scaleFactor *
        (0.8 + Math.sin(variableT * pulseSpeed) * 0.2 * particleVariance) *
        particleSize;
