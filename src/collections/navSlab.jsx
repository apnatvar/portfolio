    ...
    return(
        <section className="nav-slab glass-slab" id="home">
            <div className="horizontal-list">
                ...
                <p className="horizontal-list-element" onClick={() => handleScrollTo('home', 2000)}>Home</p>
                <p className="horizontal-list-element" onClick={() => handleScrollTo('social', 2000)}>Connect</p>
