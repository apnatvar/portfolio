    ...
    return(
        <footer className="footer">
            ...
            <div className="contact-me right-div glass-slab">
                <p className="institute centre">Get in touch</p>
                ...
                <p className="ed-description centre"><Link href="https://www.linkedin.com/in/apnatva-singh-rawat/" target="_blank"><SiLinkedin /> LinkedIn</Link></p>
                <p className="ed-description centre"><Link href="https://github.com/apnatvar/" target="_blank"><SiGithub /> GitHub</Link></p>
                <p className="ed-description centre"><Link href="https://www.instagram.com/nattupi/" target="_blank"><SiInstagram /> Instagram</Link></p>
